...
/**
 * ReclamacionesFixture
 *
 */
class ReclamacionesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_reclamaciones_solicitudes_idx' => ['type' => 'index', 'columns' => ['solicitude_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_reclamaciones_solicitudes' => ['type' => 'foreign', 'columns' => ['solicitude_id'], 'references' => ['solicitudes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
