 ...
 *
 */
class SolicitantesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'fk_Solicitante_Usuario1_idx' => ['type' => 'index', 'columns' => ['Usuario_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_Solicitante_Usuario1' => ['type' => 'foreign', 'columns' => ['Usuario_id'], 'references' => ['usuarios', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
