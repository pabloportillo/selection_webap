...
<div class="usuarios form large-9 medium-8 columns content">
   <!-- array('type'=>'file') PORQUE SE VAN A SUBIR ARCHIVOS (FOTO) -->
    ...
    <div class="form-group row">
        <div class="col-xs-6">
            <?php
          //  echo $this->Form->control('Contraseña', ['type' => 'password', 'value'=>'', 'autocomplete'=>'off', 'required' => true]);
    ...
    <?php
        ...
        <div class="col-xs-6">
			...
			if(isset($confirm_pass)){
			     ...
			     echo $this->Form->control('Contraseña_match', ['type' => 'password', 'label' => 'Confirma Contraseña *', 'required' => true,'class' => 'form-control']); 
			}
            ?>
    ...
    <?php
		if (!$authUser)
		{ 
		    echo $this->Form->control('Perfile_id', ['templates' => ['inputContainer' => '{{content}}'], 'label' => false, 'options' => $perfiles, 'value' => 5, 'required' => false, 'hidden' => true]);
		}else
		{ ?>
	    <div class="form-group row">
            <div class="col-xs-12">
        <?php    
		    echo $this->Form->control('Perfile_id', ['options' => $perfiles, 'label' => 'Perfil *', 'required' => true,'class' => 'form-control']);
		?>
			</div>
		</div>
		<?php
		...
		?>
    <div class="form-group row">
		<div class="col-xs-12" id="empresa">
		<?php       
	...
	<div class="form-group row">
        <div class="col-xs-6">
		<?php
            echo $this->Form->control('Dni', ['class' => 'form-control', 'label' => 'Dni *']); 
        ?>
        </div>
        <div class="col-xs-6">
        <?php
            echo $this->Form->control('Direccion', ['class' => 'form-control', 'label' => 'Direccion *']);
        ?>
        </div>
    </div>
	<div class="form-group row">
  ...
  <button type="submit" class="btn btn-primary" style="float: right">Añadir usuario</button>
    <?= $this->Form->end() ?>
</div>